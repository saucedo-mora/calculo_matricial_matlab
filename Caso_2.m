function [force_ini, displacement, num_ele, stiffness, force, A, E, ele_dof, I, num_nod, L, known_dis_a, e, nod_coor, i, ele_nod] = Caso_2(L_refine)
    % CASO 2
    ...
    % 2 %
    nod_coor=[0 0;0 500;0 1000;0 2000;1000 0; 1000 500;1000 1000;1000 2000];
    ...
    % 1 % 
    ele_nod_pre=[1 2; 2 3; 3 4; 5 6; 6 7; 7 8; 2 6; 4 8];
    %number of elements
