function [force_ini, displacement, num_ele, stiffness, force, A, E, ele_dof, I, num_nod, L, known_dis_a, e, nod_coor, i, ele_nod] = Caso_7(L_refine)
        % CASO 2
    ...
    % 1 % 
    nod_coor=[0 0; 0 500; -250 -250; 250 -250];
    
    %%%% ELEMENTOS -----------------------
    
    % elements nodes    %%%% CAMBIAR    2.-
    % 1 % 
    ele_nod_pre=[1 2; 1 3; 1 4];
     %number of elements
