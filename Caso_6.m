function [force_ini, displacement, num_ele, stiffness, force, A, E, ele_dof, I, num_nod, L, known_dis_a, e, nod_coor, i, ele_nod] = Caso_6(L_refine)
        % CASO 2
    ...
    % 1 % 
    nod_coor=[0 0;500 0; 1000 0; 1500 0; 500 -500; 1000 -500];
    
    %%%% ELEMENTOS -----------------------
    
    % elements nodes    %%%% CAMBIAR    2.-
    % 1 % 
    ele_nod_pre=[1 2; 2 3; 3 4; 2 5; 3 6];
     %number of elements
    ...
    displacement (16,1)=0.0;
    displacement (17,1)=0.0;

    
    %%%% CAMBIAR  6.-
    % Desplazamientos con restriccion
    known_dis_a=[1;2;10;11;13;14;16;17];
